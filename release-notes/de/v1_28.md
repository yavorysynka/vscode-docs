...
> > If you'd like to read these release notes online, go to [Updates](https://code.visualstudio.com/updates) on [code.visualstudio.com](https://code.visualstudio.com).<br> You can also check out this 1.28 release [highlights video](https://youtu.be/QFC4HxR3wI8) from Cloud Developer Advocate [Brian Clark](https://twitter.com/_clarkio).
...
* Morten N.O. [Morten N.O. Nørgaard Henriksen (@raix)](https://github.com/raix): Add branch name validation and whitespace config [PR #50712](https://github.com/microsoft/vscode/pull/50712)</li> 
...
* [Winner Crespo (@wistcc)](https://github.com/wistcc) 
  ...
  * Adding the git.showStagedChangesResourceGroup config property [PR #55976](https://github.com/microsoft/vscode/pull/55976)</ul> 
