...
> > If you'd like to read these release notes online, go to [Updates](https://code.visualstudio.com/updates) on [code.visualstudio.com](https://code.visualstudio.com).<br> You can also check out this 1.19 release [highlights video](https://youtu.be/p6-7GLHWdac) from Cloud Developer Advocate [Brian Clark](https://twitter.com/_clarkio).
...
* [Morten N.O. Morten N.O. Nørgaard Henriksen (@raix)](https://github.com/raix)
...
* **Serbian:** Darko Puflović, Марко М. Костић, Nikola Radovanović. Костић, Nikola Radovanović.
