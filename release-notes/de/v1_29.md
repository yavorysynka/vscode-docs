...
> > If you'd like to read these release notes online, go to [Updates](https://code.visualstudio.com/updates) on [code.visualstudio.com](https://code.visualstudio.com).<br> You can also check out this 1.29 release [highlights video](https://youtu.be/g5MZ89F8G0U) from Cloud Developer Advocate [Brian Clark](https://twitter.com/_clarkio).
...
Bundled extensions load faster. We therefore created a sample that shows how to \[webpack an extension\]( https://github.com/microsoft/vscode-extension-samples/blob/master/webpack-sample/README.md).
...
* **German:** J.M. Rütter, Volkmar Rigo. Rütter, Volkmar Rigo.
