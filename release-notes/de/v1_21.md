...
> > If you'd like to read these release notes online, go to [Updates](https://code.visualstudio.com/updates) on [code.visualstudio.com](https://code.visualstudio.com).<br> You can also check out this 1.21 release [highlights video](https://youtu.be/1hDFysLSVPo) from Cloud Developer Advocate [Brian Clark](https://twitter.com/_clarkio).
...
* [Yoshiharu Hirose (@yh1224)](https://github.com/yh1224):  Treat full-width character as two visible columns. [Joe Berria (@nexes)](https://github.com/nexes):  fix issue #40848 show extension tab if extension has previously been … [PR #42071](https://github.com/microsoft/vscode/pull/42071)
...
* [Chance An (@changsi-an)](https://github.com/changsi-an)
  ...
  * Allow child-class to customize the creation of IVariableContainer . [PR #279](https://github.com/microsoft/vscode-chrome-debug-core/pull/279) [PR #279](https://github.com/microsoft/vscode-chrome-debug-core/pull/279)
...
* **Serbian:** Марко М. Костић, Nikola Radovanović, Pavle Rohalj. Костић, Nikola Radovanović, Pavle Rohalj.
