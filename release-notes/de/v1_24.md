...
> If you'd like to read these release notes online, go to [Updates](https://code.visualstudio.com/updates) on [code.visualstudio.com](https://code.visualstudio.com).<br> You can also check out this 1.24 release [highlights video](https://youtu.be/KdxigzrbCI0) from Cloud Developer Advocate [Brian Clark](https://twitter.com/_clarkio).
